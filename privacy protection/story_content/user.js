...
var front = document.querySelectorAll("[data-acc-text='CISO']");
...
{
  // בחירת האלמנטים (השמות צריכים להתאים לשמות ב-Timeline)
var front = document.querySelectorAll("[data-acc-text='DPO']");
var back = document.querySelectorAll("[data-acc-text='CardBack']");
...
{
  // בחירת האלמנטים (השמות צריכים להתאים לשמות ב-Timeline)
var front = document.querySelectorAll("[data-acc-text='Personal Information']");
var back = document.querySelectorAll("[data-acc-text='CardBack']");
...
{
  // בחירת האלמנטים (השמות צריכים להתאים לשמות ב-Timeline)
var front = document.querySelectorAll("[data-acc-text='Sensitive Data']");
var back = document.querySelectorAll("[data-acc-text='CardBack']");
...
{
  // בחירת האלמנטים (השמות צריכים להתאים לשמות ב-Timeline)
var front = document.querySelectorAll("[data-acc-text='2FA']");
var back = document.querySelectorAll("[data-acc-text='CardBack']");
...
{
  // בחירת האלמנטים (השמות צריכים להתאים לשמות ב-Timeline)
var front = document.querySelectorAll("[data-acc-text='AI']");
var back = document.querySelectorAll("[data-acc-text='CardBack']");
